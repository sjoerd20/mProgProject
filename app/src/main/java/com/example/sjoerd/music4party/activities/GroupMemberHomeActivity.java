...
public class GroupMemberHomeActivity extends AppCompatActivity implements YoutubeSearchRequest.Callback {
    ...
    /*
     * Set up a toolbar, a listview for showing videos, a view for the current video
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listViewVideos.setOnItemClickListener(new GroupMemberHomeActivity.OnVideoClicked());
        ...
        Video firstVideo = new Video("Mariage d'Amour - Paul de Senneville || Jacob's Piano",
                "FoCG-WNsZio",
                "https://i.ytimg.com/vi/FoCG-WNsZio/default.jpg");
        retrievedPlaylist.addVideo(firstVideo);

        // Setup current video
        try {
            Video video = retrievedPlaylist.getPlaylist().get(0);
            ...
            ImageView thumbnail = findViewById(R.id.thumbnailView);
            Picasso.with(this).load(video.getThumbnailURL()).into(thumbnail);
        }
    ...
    public void gotVideos(ArrayList<Video> videos) {
        try {
            ...
            Toast.makeText(this, "No matching videos found",
